...
private var atlasBaseSearchSkinFace : Object[];//search for the texture at directory 
...
private var headAddSearch : Object[];          //search for the texture at directory 
...
private var EyeBrowSearch : Object[];          //search for the texture at directory 
...
private var ScarsSearch : Object[];          //search for the texture at directory 
...
private var BeardSearch : Object[];          //search for the texture at directory 
...
private var HairSkullSearch : Object[];          //search for the texture at directory 
...
private var EyeSearch : Object[];          //search for the texture at directory 
...
private var PantSearch : Object[];          //search for the texture at directory 
...
private var TorsoSearch : Object[];          //search for the texture at directory 
...
private var ShoeSearch : Object[];          //search for the texture at directory 
...
private var GloveSearch : Object[];          //search for the texture at directory 
...
private var BeltSearch : Object[];          //search for the texture at directory 
...
private var colorPilosityNumber = 0;
 ...
 var cloakSearch : Object[];          //search for the texture at directory 
 ...
 var robeLongB = false;
 var robeShortSearch : Object[];          //search for the texture at directory 
 ...
 var robeLongSearch : Object[];          //search for the texture at directory 
...
// AtlasBase Texture SkinFace
	atlasBaseSearchSkinFace = Resources.LoadAll("Character_Editor/Textures/Character/HumanMale/HumanMale_Color/Color"+colorNumber, Texture2D);//.Cast.<Texture2D>().ToArray();
	...
	for(var a = 0; a < atlasBaseSearchSkinFace.Length; ++a){
		atlasBaseSkinFace[a] = Resources.Load("Character_Editor/Textures/Character/HumanMale/HumanMale_Color/Color0/HumanMale_Color0_FaceSkin" + a + "", Texture2D) as Texture2D;
...
// HeadAdd Texture in folder 
	headAddSearch = Resources.LoadAll("Character_Editor/Textures/CharacterOutfit/Head_add", Texture2D);
	...
	for(var b = 0; b < headAddSearch.Length; ++b){																      						   //fill with Texture2D
		headAdd[b] = Resources.Load("Character_Editor/Textures/CharacterOutfit/Head_add/headAdd" +b+ "", Texture2D) as Texture2D;}
    headAddQ = headAdd.Length;  

// EyeBrow Texture in folder
	EyeBrowSearch = Resources.LoadAll("Character_Editor/Textures/Character/HumanMale/HumanMale_Eyebrow/Color0", Texture2D);
	...
	for(var c = 0; c < EyeBrowSearch.Length; ++c){																      						   //fill with Texture2D
		EyeBrow[c] = Resources.Load("Character_Editor/Textures/Character/HumanMale/HumanMale_Eyebrow/Color0/EyeBrow" +c+ "_Color0", Texture2D) as Texture2D;}
    EyeBrowQ = EyeBrow.Length;  
                                                                                                                  //texture Quantity  
 // Scars Texture in folder  
	ScarsSearch = Resources.LoadAll("Character_Editor/Textures/Character/HumanMale/HumanMale_Scars", Texture2D);
	...
	for(var d = 0; d < ScarsSearch.Length; ++d){																      						   //fill with Texture2D
		Scars[d] = Resources.Load("Character_Editor/Textures/Character/HumanMale/HumanMale_Scars/Scars" +d+ "", Texture2D) as Texture2D;}
    ScarsQ = Scars.Length;  
  
  // Beard Texture in folder  
	BeardSearch =Resources.LoadAll("Character_Editor/Textures/Character/HumanMale/HumanMale_Beard/Color0", Texture2D);
	...
	for(var e = 0; e < BeardSearch.Length; ++e){																      						   //fill with Texture2D
		Beard[e] = Resources.Load("Character_Editor/Textures/Character/HumanMale/HumanMale_Beard/Color0/Beard" +e+ "_Color0", Texture2D) as Texture2D;}
    BeardQ = Beard.Length;  
    
 // HairSkull Texture in folder  
	HairSkullSearch = Resources.LoadAll("Character_Editor/Textures/Character/HumanMale/HumanMale_HairSkull/Color0", Texture2D);					 //search texture by name for array length
	HairSkull = new Texture2D[HairSkullSearch.length];                                                              								//resize array
	for(var g = 0; g < HairSkullSearch.Length; ++g){																      						   //fill with Texture2D
		HairSkull[g] = Resources.Load("Character_Editor/Textures/Character/HumanMale/HumanMale_HairSkull/Color0/HumanMale_HairSkull" +g+ "_Color0", Texture2D) as Texture2D;}
    HairSkullQ = HairSkull.Length;  

// Eye Texture in folder 
	EyeSearch = Resources.LoadAll("Character_Editor/Textures/Character/HumanMale/HumanMale_Eye", Texture2D);								 //search texture by name for array length
	Eye = new Texture2D[EyeSearch.length];                                                              								//resize array
	for(var f = 0; f < EyeSearch.Length; ++f){																      						   //fill with Texture2D
		Eye[f] = Resources.Load("Character_Editor/Textures/Character/HumanMale/HumanMale_Eye/Eye" +f+ "", Texture2D) as Texture2D;}
    EyeQ = Eye.Length; 

// Pant Texture in folder 
	PantSearch =Resources.LoadAll("Character_Editor/Textures/CharacterOutfit/Pant", Texture2D);						 //search texture by name for array length
	Pant = new Texture2D[PantSearch.length];                                                              								//resize array
	for(var i = 0; i < PantSearch.Length; ++i){																      						   //fill with Texture2D
		Pant[i] = Resources.Load("Character_Editor/Textures/CharacterOutfit/Pant/Pant" +i+ "", Texture2D) as Texture2D;}
    PantQ = Pant.Length;

// Torso Texture in folder 
	TorsoSearch = Resources.LoadAll("Character_Editor/Textures/CharacterOutfit/Torso", Texture2D);							 //search texture by name for array length
	Torso = new Texture2D[TorsoSearch.length];                                                              								//resize array
	for(var j = 0; j < TorsoSearch.Length; ++j){																      						   //fill with Texture2D
		Torso[j] = Resources.Load("Character_Editor/Textures/CharacterOutfit/Torso/Torso" +j+ "", Texture2D) as Texture2D;}
    TorsoQ = Torso.Length; 

// Shoe Texture in folder 
	ShoeSearch = Resources.LoadAll("Character_Editor/Textures/CharacterOutfit/Shoe", Texture2D);					 //search texture by name for array length
	Shoe = new Texture2D[ShoeSearch.length];                                                              								//resize array
	for(var k = 0; k < ShoeSearch.Length; ++k){																      						   //fill with Texture2D
		Shoe[k] = Resources.Load("Character_Editor/Textures/CharacterOutfit/Shoe/Shoe" +k+ "", Texture2D) as Texture2D;}
    ShoeQ = Shoe.Length;                                                                                                                                     //texture Quantity 

// Glove Texture in folder 
	GloveSearch = Resources.LoadAll("Character_Editor/Textures/CharacterOutfit/Glove", Texture2D);						 //search texture by name for array length
	Glove = new Texture2D[GloveSearch.length];                                                              								//resize array
	for(var l = 0; l < GloveSearch.Length; ++l){																      						   //fill with Texture2D
		Glove[l] = Resources.Load("Character_Editor/Textures/CharacterOutfit/Glove/Glove" +l+ "", Texture2D) as Texture2D;}
    GloveQ = Glove.Length;   

// Belt Texture in folder 
	BeltSearch = Resources.LoadAll("Character_Editor/Textures/CharacterOutfit/Belt", Texture2D);							 //search texture by name for array length
	Belt = new Texture2D[BeltSearch.length];                                                              								//resize array
	for(var m = 0; m < BeltSearch.Length; ++m){																      						   //fill with Texture2D
		Belt[m] = Resources.Load("Character_Editor/Textures/CharacterOutfit/Belt/Belt" +m+ "", Texture2D) as Texture2D;}
    BeltQ = Belt.Length;   
// Cloak Texture in folder 

   	cloakSearch = Resources.LoadAll("Character_Editor/Textures/Armor/Cloak", Texture2D);						 //search texture by name for array length
	cloakTex = new Texture2D[cloakSearch.length];                                                              								//resize array
	for(var cl = 0; cl < cloakSearch.Length; ++cl){																      						   //fill with Texture2D
		cloakTex[cl] = Resources.Load("Character_Editor/Textures/Armor/Cloak/A_Cloak_" +cl+ "", Texture2D) as Texture2D;}
    cloakQ = cloakTex.Length;
	for(var clo2 = 0;clo2 < cloak.Length; clo2++ ){
	cloak[clo2].SetActive(false);
	}
// robeLong Texture in folder 
	robeLongSearch =Resources.LoadAll("Character_Editor/Textures/CharacterOutfit/RobeLong", Texture2D);							 //search texture by name for array length
	robeLongTex = new Texture2D[robeLongSearch.length];                                                              								//resize array
	for(var rl = 0; rl < robeLongSearch.Length; ++rl){																      						   //fill with Texture2D
		robeLongTex[rl] = Resources.Load("Character_Editor/Textures/CharacterOutfit/RobeLong/RobeLong" +rl+ "", Texture2D) as Texture2D;}
    robeLongQ = robeLongTex.Length;

// robeShort Texture in folder 
	robeShortSearch = Resources.LoadAll("Character_Editor/Textures/CharacterOutfit/RobeShort", Texture2D);							 //search texture by name for array length
	...
	for(var rsh = 0; rsh < robeShortSearch.Length; ++rsh){																      						   //fill with Texture2D
		robeShortTex[rsh] = Resources.Load("Character_Editor/Textures/CharacterOutfit/RobeShort/RobeShort" +rsh+ "", Texture2D) as Texture2D;}
...
// EyeBrow Texture in folder 	
	...
	for(var cP = 0; cP < EyeBrowSearch.Length; ++cP){																      						   //fill with Texture2D
		EyeBrow[cP] = Resources.Load("Character_Editor/Textures/Character/HumanMale/HumanMale_Eyebrow/Color"+colorPilosityNumber+"/EyeBrow" +cP+ "_Color"+colorPilosityNumber+"", Texture2D) as Texture2D;}
    EyeBrowQ = EyeBrow.Length;  
// Beard Texture in folder  
	Beard = new Texture2D[BeardSearch.length];                                                              								//resize array
	for(var eP = 0; eP < BeardSearch.Length; ++eP){																      						   //fill with Texture2D
		Beard[eP] = Resources.Load("Character_Editor/Textures/Character/HumanMale/HumanMale_Beard/Color"+colorPilosityNumber+"/Beard" +eP+ "_Color"+colorPilosityNumber+"", Texture2D) as Texture2D;}
    BeardQ = Beard.Length;  
// HairSkull Texture in folder  
	HairSkull = new Texture2D[HairSkullSearch.length];                                                              								//resize array
	for(var gP = 0; gP < HairSkullSearch.Length; ++gP){																      						   //fill with Texture2D
		HairSkull[gP] = Resources.Load("Character_Editor/Textures/Character/HumanMale/HumanMale_HairSkull/Color"+colorPilosityNumber+"/HumanMale_HairSkull" +gP+ "_Color"+colorPilosityNumber+"", Texture2D) as Texture2D;}
    HairSkullQ = HairSkull.Length;  
   ...
   // those function texture are a cascade of function, from color skin to belt every texture are aplied   // each time you lunch a function it start the following texure function
       function loadPlayer(nBelt,nGlove,nShoe,nTorso,nPant,nEye,nHairSkull,nBeard,nScars,nEyeBrow ,nheadAdd ,nskinFace ,ncolorNumber,nColorPilosity,nRobeLong,nRobeShort,naHairModel,naHead,naJaw,naEye,naTorso,naTorsoAdd,naBelt,naBeltAdd,naShoulderR,naShoulderL,naArmR,naArmL,naLegR,naLegL,naWeaponR,naWeaponL ){
		...
		PantN=nPant;
		EyeN=nEye;
		HairSkullN=nHairSkull;
		BeardN=nBeard;
		ScarsN=nScars;
		EyeBrowN=nEyeBrow;
		headAddN=nheadAdd;
		skinFaceN=nskinFace;
		colorNumber =ncolorNumber;
		
					////////////
					
					colorPilosityNumber = nColorPilosity;
					...
					hairModelN = naHairModel;
					headN = naHead;	
					jawN = naJaw;
					eyeN = naEye;
					torsoN = naTorso;
					torsoAddN = naTorsoAdd;
					beltN = naBelt;
					beltAddN = naBeltAdd;
					shoulderRN = naShoulderR;
					shoulderLN = naShoulderL;
					armRN = naArmR;
					armLN = naArmL;
					legRN = naLegR;
					legLN = naLegL;
...
function ColorSkinF () {
	...
	for(var a = 0; a < atlasBaseSearchSkinFace.Length; ++a){
		...
		"Character_Editor/Textures/Character/HumanMale/HumanMale_Color/Color"+colorNumber+"/HumanMale_Color"+colorNumber+"_FaceSkin" +a+ "", Texture2D) as Texture2D;}
	skinFaceQ = atlasBaseSkinFace.Length;
...
function hairModelEquip(){
		...
		if(hairModelN >=0 && hairModelN <= hairModelQ ){
			...
			for(var ht = 0; ht < 4; ++ht){																      						   //fill with Texture2D
				hairTex[ht] = Resources.Load("Character_Editor/Textures/Armor/HairModel/"+hairModelN+"/A_HumanMale_HairModel_" +hairModelN+ "_Color_"+ht+"", Texture2D) as Texture2D;
				}
...
function JawEquip(){
		...
		if(jawN >=0 && jawN <= jawQ - 1){
			...
			for(var jt = 0; jt < 4; ++jt){																      						   //fill with Texture2D
				jawTex[jt] = Resources.Load("Character_Editor/Textures/Armor/Jaw/"+jawN+"/A_HumanMale_BeardModel_" +jawN+ "_Color_"+jt+"", Texture2D) as Texture2D;
				}
