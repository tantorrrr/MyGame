...
namespace RootMotion {
	...
	public class CameraController : MonoBehaviour {
        ...
        public GameObject secondCameraHelper;
        /// </summary>
        ...
        public void UpdateTransform(float deltaTime) {
            ...
            {
                position = smoothPosition + rotation * (offset - Vector3.forward * addDistance);
                transform.position = position;
            }
            ...
            ///
            secondCameraHelper.transform.rotation = rotation;
            secondCameraHelper.transform.position = smoothPosition + rotation * (offset - Vector3.forward * distance);
        }
