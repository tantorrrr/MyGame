...
using RootMotion.Dynamics;
	...
	public class MuscleCollisionBroadcaster : MonoBehaviour {
        ...
        private void Start()
        {
        animator = transform.root.Find("Character Controller/Animation Controller").GetComponent<Animator>();
        }
    public void Hit(float unPin, Vector3 force, Vector3 position, bool reaction, float hitDirection) {
       ...
       /* if (reaction && animator.GetFloat("HitTurn") == 0f)
        {
            animator.SetFloat("HitTurn", hitDirection);
