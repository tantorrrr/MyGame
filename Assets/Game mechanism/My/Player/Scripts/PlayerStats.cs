...
public class PlayerStats : MonoBehaviour {
    ...
    public Image CHPImage;
    public RectTransform CHPImageParentPanel;
    ...
    {
        float left = 0f;
        float right = -((CHPImageParentPanel.offsetMax.x - CHPImageParentPanel.offsetMin.x) - (hp* ((CHPImageParentPanel.offsetMax.x - CHPImageParentPanel.offsetMin.x)/100)));
        float top = 0;
        float bottom = 0;
       // Debug.LogError(CHPImageParentPanel.offsetMax.x - CHPImageParentPanel.offsetMin.x);
        RectTransform this_rect = CHPImage.rectTransform;
        
        this_rect.anchorMin = new Vector2(0, 0);
        this_rect.anchorMax = new Vector2(1, 1);
        Vector2 temp = new Vector2(left, top);
        this_rect.offsetMin = temp;
        temp = new Vector3(right, bottom);
        this_rect.offsetMax = temp;
        //Debug.LogError(-this_rect.offsetMax.x);
