...
public class LoginSystem : MonoBehaviour {
    ...
    public ShowPanelAndCloseOther mainPanel;
    public ShowPanelAndCloseOther activatePanel;
    private string info;
	...
	IEnumerator Query_Account (){
		...
		Debug.LogError (checkBanned.text);
		if (checkBanned.text.Trim () == "1" || checkBanned.text.Trim () == "3") {
            ...
            WarningMsg.text=(split[0].Trim());
			if (split [0].Trim () == "1") {
                WarningMsg.text = ("Logging...");
